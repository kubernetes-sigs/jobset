...
func RecordJobSetTerminalState(jobSet *jobset.JobSet) {
	...
	metrics.RecordJobSetTerminalState(jobSet.Name, jobSet.Namespace, jobSet.Status.TerminalState, boolToFloat64(currentPhase == string(jobset.JobSetCompleted)))
	metrics.RecordJobSetTerminalState(jobSet.Name, jobSet.Namespace, jobSet.Status.TerminalState, boolToFloat64(currentPhase == string(jobset.JobSetFailed)))
}
