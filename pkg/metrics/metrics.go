...
var (
	...
	JobSetTerminalState = prometheus.NewGaugeVec(
		...
		}, []string{"jobset_name", "namespace", "terminal_state"},
	)
)
...
// label values:
// - jobSet: The name of the JobSet.
// - namespace: The namespace where the JobSet resides.
...
func RecordJobSetTerminalState(jobSet, namespace, phase string, value float64) {
	JobSetTerminalState.WithLabelValues(jobSet, namespace, phase).Set(value)
}
