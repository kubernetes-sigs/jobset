...
// Package v1alpha1 contains API Schema definitions for the jobset v1alpha1 API group
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "config.jobset.x-k8s.io", Version: "v1alpha1"}
