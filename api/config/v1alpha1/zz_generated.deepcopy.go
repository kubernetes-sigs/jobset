...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ControllerEvents) DeepCopyInto(out *ControllerEvents) {
	*out = *in
	if in.ThrottlingWindowSize != nil {
		in, out := &in.ThrottlingWindowSize, &out.ThrottlingWindowSize
		*out = new(v1.Duration)
		**out = **in
	}
	if in.ThrottlingCacheSize != nil {
		in, out := &in.ThrottlingCacheSize, &out.ThrottlingCacheSize
		*out = new(int)
		**out = **in
	}
	if in.ThrottlingCacheResetInterval != nil {
		in, out := &in.ThrottlingCacheResetInterval, &out.ThrottlingCacheResetInterval
		*out = new(v1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControllerEvents.
func (in *ControllerEvents) DeepCopy() *ControllerEvents {
	if in == nil {
		return nil
	}
	out := new(ControllerEvents)
	in.DeepCopyInto(out)
	return out
}
