...
func (in *Exclusive) DeepCopyInto(out *Exclusive) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Exclusive.
func (in *Exclusive) DeepCopy() *Exclusive {
	if in == nil {
		return nil
	}
	out := new(Exclusive)
