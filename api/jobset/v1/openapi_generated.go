...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"sigs.k8s.io/jobset/api/jobset/v1.Coordinator":         schema_jobset_api_jobset_v1_Coordinator(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.DependsOn":           schema_jobset_api_jobset_v1_DependsOn(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.FailurePolicy":       schema_jobset_api_jobset_v1_FailurePolicy(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.FailurePolicyRule":   schema_jobset_api_jobset_v1_FailurePolicyRule(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.JobSet":              schema_jobset_api_jobset_v1_JobSet(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.JobSetList":          schema_jobset_api_jobset_v1_JobSetList(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.JobSetSpec":          schema_jobset_api_jobset_v1_JobSetSpec(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.JobSetStatus":        schema_jobset_api_jobset_v1_JobSetStatus(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.Network":             schema_jobset_api_jobset_v1_Network(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.ReplicatedJob":       schema_jobset_api_jobset_v1_ReplicatedJob(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.ReplicatedJobStatus": schema_jobset_api_jobset_v1_ReplicatedJobStatus(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.StartupPolicy":       schema_jobset_api_jobset_v1_StartupPolicy(ref),
		"sigs.k8s.io/jobset/api/jobset/v1.SuccessPolicy":       schema_jobset_api_jobset_v1_SuccessPolicy(ref),
	}
}

func schema_jobset_api_jobset_v1_Coordinator(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_jobset_api_jobset_v1_DependsOn(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_jobset_api_jobset_v1_FailurePolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										...
										Ref:     ref("sigs.k8s.io/jobset/api/jobset/v1.FailurePolicyRule"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"sigs.k8s.io/jobset/api/jobset/v1.FailurePolicyRule"},
	}
}

func schema_jobset_api_jobset_v1_FailurePolicyRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_jobset_api_jobset_v1_JobSet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("sigs.k8s.io/jobset/api/jobset/v1.JobSetSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("sigs.k8s.io/jobset/api/jobset/v1.JobSetStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "sigs.k8s.io/jobset/api/jobset/v1.JobSetSpec", "sigs.k8s.io/jobset/api/jobset/v1.JobSetStatus"},
	}
}

func schema_jobset_api_jobset_v1_JobSetList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("sigs.k8s.io/jobset/api/jobset/v1.JobSet"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "sigs.k8s.io/jobset/api/jobset/v1.JobSet"},
	}
}

func schema_jobset_api_jobset_v1_JobSetSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("sigs.k8s.io/jobset/api/jobset/v1.ReplicatedJob"),
									},
								},
							},
						},
					...
					"network": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("sigs.k8s.io/jobset/api/jobset/v1.Network"),
						},
					},
					"successPolicy": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("sigs.k8s.io/jobset/api/jobset/v1.SuccessPolicy"),
						},
					},
					"failurePolicy": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("sigs.k8s.io/jobset/api/jobset/v1.FailurePolicy"),
						},
					},
					"startupPolicy": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("sigs.k8s.io/jobset/api/jobset/v1.StartupPolicy"),
						},
					},
					"suspend": {
						SchemaProps: spec.SchemaProps{
					...
					"coordinator": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("sigs.k8s.io/jobset/api/jobset/v1.Coordinator"),
						},
					},
					"managedBy": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"sigs.k8s.io/jobset/api/jobset/v1.Coordinator", "sigs.k8s.io/jobset/api/jobset/v1.FailurePolicy", "sigs.k8s.io/jobset/api/jobset/v1.Network", "sigs.k8s.io/jobset/api/jobset/v1.ReplicatedJob", "sigs.k8s.io/jobset/api/jobset/v1.StartupPolicy", "sigs.k8s.io/jobset/api/jobset/v1.SuccessPolicy"},
	}
}

func schema_jobset_api_jobset_v1_JobSetStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("sigs.k8s.io/jobset/api/jobset/v1.ReplicatedJobStatus"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.Condition", "sigs.k8s.io/jobset/api/jobset/v1.ReplicatedJobStatus"},
	}
}

func schema_jobset_api_jobset_v1_Network(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_jobset_api_jobset_v1_ReplicatedJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("sigs.k8s.io/jobset/api/jobset/v1.DependsOn"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/api/batch/v1.JobTemplateSpec", "sigs.k8s.io/jobset/api/jobset/v1.DependsOn"},
	}
}

func schema_jobset_api_jobset_v1_ReplicatedJobStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_jobset_api_jobset_v1_StartupPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_jobset_api_jobset_v1_SuccessPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
