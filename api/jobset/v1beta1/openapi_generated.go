...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"sigs.k8s.io/jobset/api/jobset/v1beta1.FailurePolicy":       schema_jobset_api_jobset_v1alpha2_FailurePolicy(ref),
		"sigs.k8s.io/jobset/api/jobset/v1beta1.JobSet":              schema_jobset_api_jobset_v1alpha2_JobSet(ref),
		"sigs.k8s.io/jobset/api/jobset/v1beta1.JobSetList":          schema_jobset_api_jobset_v1alpha2_JobSetList(ref),
		"sigs.k8s.io/jobset/api/jobset/v1beta1.JobSetSpec":          schema_jobset_api_jobset_v1alpha2_JobSetSpec(ref),
		"sigs.k8s.io/jobset/api/jobset/v1beta1.JobSetStatus":        schema_jobset_api_jobset_v1alpha2_JobSetStatus(ref),
		"sigs.k8s.io/jobset/api/jobset/v1beta1.Network":             schema_jobset_api_jobset_v1alpha2_Network(ref),
		"sigs.k8s.io/jobset/api/jobset/v1beta1.ReplicatedJob":       schema_jobset_api_jobset_v1alpha2_ReplicatedJob(ref),
		"sigs.k8s.io/jobset/api/jobset/v1beta1.ReplicatedJobStatus": schema_jobset_api_jobset_v1alpha2_ReplicatedJobStatus(ref),
		"sigs.k8s.io/jobset/api/jobset/v1beta1.StartupPolicy":       schema_jobset_api_jobset_v1alpha2_StartupPolicy(ref),
		"sigs.k8s.io/jobset/api/jobset/v1beta1.SuccessPolicy":       schema_jobset_api_jobset_v1alpha2_SuccessPolicy(ref),
	}
}
