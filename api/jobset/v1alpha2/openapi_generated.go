			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"targetReplicatedJob": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "targetReplicatedJob is the list of ReplicatedJob names this policy applies to. When more than one name is listed, the targeted ReplicatedJobs share a single PodGroup. Every name must be unique across all replicatedJobPolicies entries.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
