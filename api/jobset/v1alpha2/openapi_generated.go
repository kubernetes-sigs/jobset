...
func schema_jobset_api_jobset_v1_JobSetSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"sigs.k8s.io/jobset/api/jobset/v1.FailurePolicy", "sigs.k8s.io/jobset/api/jobset/v1.Network", "sigs.k8s.io/jobset/api/jobset/v1.ReplicatedJob", "sigs.k8s.io/jobset/api/jobset/v1.StartupPolicy", "sigs.k8s.io/jobset/api/jobset/v1.SuccessPolicy"},
	}
}
