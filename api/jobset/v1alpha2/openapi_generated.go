...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"sigs.k8s.io/jobset/api/jobset/v1alpha2.JobSchedulingPolicy":           schema_jobset_api_jobset_v1alpha2_JobSchedulingPolicy(ref),
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"schedulingPolicy": {
						SchemaProps: spec.SchemaProps{
							Description: "schedulingPolicy defines the composite-level scheduling policy for the entire JobSet. Defaults to Gang when spec.scheduling is set but schedulingPolicy is nil. This default does not apply when the JobSet uses sequenced startup (DependsOn or an InOrder StartupPolicy): the composite policy is left unset in that case, and each ReplicatedJob defaults to its own Gang policy instead, since a single PodGroup spanning the whole JobSet would deadlock while Jobs are created sequentially.",
							Ref:         ref("k8s.io/api/scheduling/v1alpha3.PodGroupSchedulingPolicy"),
						},
					},
					"schedulingConstraints": {
						SchemaProps: spec.SchemaProps{
							Description: "schedulingConstraints defines composite-level topology constraints for the entire JobSet.",
							Ref:         ref("k8s.io/api/scheduling/v1alpha3.PodGroupSchedulingConstraints"),
						},
					},
					"disruptionMode": {
						SchemaProps: spec.SchemaProps{
							Description: "disruptionMode defines how the entire composite group can be disrupted.",
							Ref:         ref("k8s.io/api/scheduling/v1alpha3.DisruptionMode"),
						},
					},
					"replicatedJobPolicies": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "replicatedJobPolicies specifies per-ReplicatedJob leaf-level scheduling overrides. Each entry targets one or more named ReplicatedJobs.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_jobset_api_jobset_v1alpha2_ReplicatedJobSchedulingPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ReplicatedJobSchedulingPolicy targets one or more named ReplicatedJobs with leaf-level scheduling configuration.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"targetReplicatedJob": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							Description: "targetReplicatedJob is the list of ReplicatedJob names this policy applies to. When more than one name is listed, the targeted ReplicatedJobs share a single PodGroup. Every name must be unique across all replicatedJobPolicies entries. The list is limited to a maximum of 50 jobs and the length of each replicatedJobName can not exceed 256 characters.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"jobSchedulingPolicy": {
						SchemaProps: spec.SchemaProps{
							Description: "jobSchedulingPolicy defines job-level (replica-level) scheduling configuration, where each replica of the targeted ReplicatedJobs forms its own independent gang (i.e. one PodGroup per Job) instead of sharing a single PodGroup across every replica of the targeted ReplicatedJobs. This is part of the Gang-of-Gangs model. When set, targetReplicatedJob must contain exactly one ReplicatedJob name, and the leaf-level schedulingPolicy/schedulingConstraints/disruptionMode/resourceClaims fields on this ReplicatedJobSchedulingPolicy must not be set, since they configure a shared PodGroup that jobSchedulingPolicy replaces with one PodGroup per Job.",
							Ref:         ref("sigs.k8s.io/jobset/api/jobset/v1alpha2.JobSchedulingPolicy"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/scheduling/v1alpha3.DisruptionMode", "k8s.io/api/scheduling/v1alpha3.PodGroupResourceClaim", "k8s.io/api/scheduling/v1alpha3.PodGroupSchedulingConstraints", "k8s.io/api/scheduling/v1alpha3.PodGroupSchedulingPolicy", "sigs.k8s.io/jobset/api/jobset/v1alpha2.JobSchedulingPolicy"},
	}
}
