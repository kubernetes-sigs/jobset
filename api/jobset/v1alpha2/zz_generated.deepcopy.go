...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JobSchedulingPolicy.
func (in *JobSchedulingPolicy) DeepCopy() *JobSchedulingPolicy {
	if in == nil {
		return nil
	}
	out := new(JobSchedulingPolicy)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JobSetScheduling) DeepCopyInto(out *JobSetScheduling) {
	*out = *in
	if in.SchedulingPolicy != nil {
		in, out := &in.SchedulingPolicy, &out.SchedulingPolicy
		*out = new(v1alpha3.PodGroupSchedulingPolicy)
	...
	if in.ReplicatedJobPolicies != nil {
		in, out := &in.ReplicatedJobPolicies, &out.ReplicatedJobPolicies
		*out = make([]ReplicatedJobSchedulingPolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JobSetScheduling.
func (in *JobSetScheduling) DeepCopy() *JobSetScheduling {
	if in == nil {
		return nil
	}
	out := new(JobSetScheduling)
	in.DeepCopyInto(out)
	return out
}
...
func (in *JobSetStatus) DeepCopyInto(out *JobSetStatus) {
	*out = *in
	...
	if in.PreviousInPlaceRestartAttempt != nil {
		in, out := &in.PreviousInPlaceRestartAttempt, &out.PreviousInPlaceRestartAttempt
		*out = new(int32)
		**out = **in
	}
	if in.CurrentInPlaceRestartAttempt != nil {
		in, out := &in.CurrentInPlaceRestartAttempt, &out.CurrentInPlaceRestartAttempt
		*out = new(int32)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicatedJobSchedulingPolicy) DeepCopyInto(out *ReplicatedJobSchedulingPolicy) {
	*out = *in
	if in.TargetReplicatedJob != nil {
		in, out := &in.TargetReplicatedJob, &out.TargetReplicatedJob
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SchedulingPolicy != nil {
	...
	if in.JobSchedulingPolicy != nil {
		in, out := &in.JobSchedulingPolicy, &out.JobSchedulingPolicy
		*out = new(JobSchedulingPolicy)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicatedJobSchedulingPolicy.
func (in *ReplicatedJobSchedulingPolicy) DeepCopy() *ReplicatedJobSchedulingPolicy {
	if in == nil {
		return nil
	}
	out := new(ReplicatedJobSchedulingPolicy)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolumeClaimPolicy) DeepCopyInto(out *VolumeClaimPolicy) {
	*out = *in
	if in.Templates != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolumeClaimPolicy.
func (in *VolumeClaimPolicy) DeepCopy() *VolumeClaimPolicy {
	if in == nil {
		return nil
	}
	out := new(VolumeClaimPolicy)
	in.DeepCopyInto(out)
	return out
}
