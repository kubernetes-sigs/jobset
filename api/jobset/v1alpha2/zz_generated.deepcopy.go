...
func (in *JobSetScheduling) DeepCopyInto(out *JobSetScheduling) {
	*out = *in
	if in.SchedulingPolicy != nil {
		in, out := &in.SchedulingPolicy, &out.SchedulingPolicy
		*out = new(v1alpha3.WorkloadCompositePodGroupSchedulingPolicy)
		(*in).DeepCopyInto(*out)
	}
	if in.SchedulingConstraints != nil {
		in, out := &in.SchedulingConstraints, &out.SchedulingConstraints
		*out = new(v1alpha3.WorkloadCompositePodGroupSchedulingConstraints)
		(*in).DeepCopyInto(*out)
	}
	if in.DisruptionMode != nil {
		in, out := &in.DisruptionMode, &out.DisruptionMode
		*out = new(v1alpha3.WorkloadCompositePodGroupDisruptionMode)
		(*in).DeepCopyInto(*out)
	}
	if in.ReplicatedJobs != nil {
		in, out := &in.ReplicatedJobs, &out.ReplicatedJobs
		*out = make([]ReplicatedJobScheduling, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicatedJobScheduling) DeepCopyInto(out *ReplicatedJobScheduling) {
	*out = *in
	if in.TargetReplicatedJobs != nil {
		in, out := &in.TargetReplicatedJobs, &out.TargetReplicatedJobs
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicatedJobScheduling.
func (in *ReplicatedJobScheduling) DeepCopy() *ReplicatedJobScheduling {
	if in == nil {
		return nil
	}
	out := new(ReplicatedJobScheduling)
	in.DeepCopyInto(out)
	return out
}
