...
var _ = ginkgo.Describe("jobset webhook defaulting", func() {
	...
	ginkgo.DescribeTable("jobset webhook tests",
		...
		ginkgo.Entry("gang policy with JobSetAsGang should succeed", &testCase{
			makeJobSet: func(ns *corev1.Namespace) *testing.JobSetWrapper {
				return testing.MakeJobSet("gang-as-jobset", ns.Name).
					EnableDNSHostnames(true).
					ReplicatedJob(testing.MakeReplicatedJob("rjob").
						Job(testing.MakeJobTemplate("job", ns.Name).
							PodSpec(testing.TestPodSpec).
		...
		ginkgo.Entry("gang policy with JobSetGangPerReplicatedJob should succeed", &testCase{
			makeJobSet: func(ns *corev1.Namespace) *testing.JobSetWrapper {
				return testing.MakeJobSet("gang-per-rjob", ns.Name).
					EnableDNSHostnames(true).
					ReplicatedJob(testing.MakeReplicatedJob("rjob").
						Job(testing.MakeJobTemplate("job", ns.Name).
							PodSpec(testing.TestPodSpec).
		...
		ginkgo.Entry("gang policy with JobSetWorkloadTemplate and valid workload should succeed", &testCase{
			makeJobSet: func(ns *corev1.Namespace) *testing.JobSetWrapper {
		...
		ginkgo.Entry("gang policy with JobSetWorkloadTemplate without workload should be rejected", &testCase{
			makeJobSet: func(ns *corev1.Namespace) *testing.JobSetWrapper {
				return testing.MakeJobSet("gang-template-no-wl", ns.Name).
					EnableDNSHostnames(true).
					ReplicatedJob(testing.MakeReplicatedJob("rjob").
						Job(testing.MakeJobTemplate("job", ns.Name).
							PodSpec(testing.TestPodSpec).
		...
		ginkgo.Entry("gang policy with JobSetWorkloadTemplate with empty podGroups should be rejected", &testCase{
			makeJobSet: func(ns *corev1.Namespace) *testing.JobSetWrapper {
		...
		ginkgo.Entry("gang policy with JobSetWorkloadTemplate with invalid gang policy (minCount <= 0) should be rejected", &testCase{
			makeJobSet: func(ns *corev1.Namespace) *testing.JobSetWrapper {
		...
		ginkgo.Entry("gang policy with JobSetAsGang should not have workload set", &testCase{
			makeJobSet: func(ns *corev1.Namespace) *testing.JobSetWrapper {
				return testing.MakeJobSet("gang-as-with-wl", ns.Name).
					EnableDNSHostnames(true).
					ReplicatedJob(testing.MakeReplicatedJob("rjob").
						Job(testing.MakeJobTemplate("job", ns.Name).
							PodSpec(testing.TestPodSpec).
