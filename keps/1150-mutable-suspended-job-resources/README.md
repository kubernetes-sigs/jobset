...
- **Upstream dependency:** This feature requires the Kubernetes
  `MutablePodResourcesForSuspendedJobs` feature gate ([KEP-5440](https://github.com/kubernetes/enhancements/blob/master/keps/sig-apps/5440-mutable-job-pod-resource-updates/README.md)),
