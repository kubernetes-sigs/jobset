...
own gang. This is part of the Gang-of-Gangs model and is reserved for future use;
the controller does not yet build scheduling resources from this field.</p>
...
PodGroup. Every name must be unique across all replicatedJobPolicies entries.</p>
</td>
</tr>
<tr><td><code>schedulingPolicy</code><br/>
<a href="https://github.com/kubernetes/enhancements/tree/master/keps/sig-scheduling/4671-gang-scheduling"><code>k8s.io/api/scheduling/v1alpha3.PodGroupSchedulingPolicy</code></a>
...
where each replica of the targeted ReplicatedJobs forms its own gang. This is
reserved for the Gang-of-Gangs model and is not yet consumed by the controller.</p>
</td>
</tr>
</tbody>
</table>
