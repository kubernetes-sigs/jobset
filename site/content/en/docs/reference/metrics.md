...
| Metric Name                                | Type    | Description                                                                                     | Labels                                                                                             |
|--------------------------------------------|---------|-------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| `jobset_failed_total`                      | Counter | The total number of failed JobSets.                                                            | `jobset_name`: Name of the JobSet.                                                                |
| `jobset_completed_total`                   | Counter | The total number of completed JobSets.                                                         | `jobset_name`: Name of the JobSet.                                                                |
| `jobset_terminal_state`                    | Gauge   | The current number of JobSets in a terminal state (e.g., Completed, Failed).                   | `jobset_name`: Name of the JobSet.<br>`namespace`: Namespace where the JobSet resides.<br>`terminal_state`: Terminal state of the JobSet (e.g., "Completed", "Failed"). |
