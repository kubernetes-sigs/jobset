...
openapi-gen:
	...
	$(PROJECT_DIR)/bin/openapi-gen --go-header-file hack/boilerplate.go.txt -i sigs.k8s.io/jobset/api/jobset/v1alpha1 -p sigs.k8s.io/jobset/api/jobset/v1alpha1 --alsologtostderr
	if [ $(GOPATH)/src/sigs.k8s.io/jobset/api/jobset/v1alpha1/openapi_generated.go != $(PROJECT_DIR)/api/jobset/v1alpha2/openapi_generated.go ]; then \
		mv $(GOPATH)/src/sigs.k8s.io/jobset/api/jobset/v1alpha1/openapi_generated.go $(PROJECT_DIR)/api/jobset/v1alpha2/openapi_generated.go; \
	fi
