...
import (
	...
	jobsetv1beta1 "sigs.k8s.io/jobset/api/jobset/v1beta1"
	...
	v1beta1 "sigs.k8s.io/jobset/client-go/listers/jobset/v1beta1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JobsetV1beta1().JobSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JobsetV1beta1().JobSets(namespace).Watch(context.TODO(), options)
			},
		},
		&jobsetv1beta1.JobSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *jobSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jobsetv1beta1.JobSet{}, f.defaultInformer)
}

func (f *jobSetInformer) Lister() v1beta1.JobSetLister {
	return v1beta1.NewJobSetLister(f.Informer().GetIndexer())
}
