...
import (
	...
	v1 "sigs.k8s.io/jobset/client-go/listers/jobset/v1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.JobsetV1().JobSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JobsetV1().JobSets(namespace).Watch(context.TODO(), options)
			},
		},
		&jobsetv1.JobSet{},
		resyncPeriod,
...
func (f *jobSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jobsetv1.JobSet{}, f.defaultInformer)
}

func (f *jobSetInformer) Lister() v1.JobSetLister {
	return v1.NewJobSetLister(f.Informer().GetIndexer())
}
