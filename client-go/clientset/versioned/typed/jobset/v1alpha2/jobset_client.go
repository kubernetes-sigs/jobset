...
// NewForConfig creates a new JobsetV1alpha2Client for the given config.
...
// NewForConfigAndClient creates a new JobsetV1alpha2Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*JobsetV1alpha2Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &JobsetV1alpha2Client{client}, nil
}

// NewForConfigOrDie creates a new JobsetV1alpha2Client for the given config and
