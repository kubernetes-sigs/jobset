...
type JobSetInterface interface {
	...
	Apply(ctx context.Context, jobSet *jobsetv1alpha1.JobSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.JobSet, err error)
	ApplyStatus(ctx context.Context, jobSet *jobsetv1alpha1.JobSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.JobSet, err error)
	JobSetExpansion
}
...
func (c *jobSets) Apply(ctx context.Context, jobSet *jobsetv1alpha1.JobSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.JobSet, err error) {
	if jobSet == nil {
...
func (c *jobSets) ApplyStatus(ctx context.Context, jobSet *jobsetv1alpha1.JobSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.JobSet, err error) {
	if jobSet == nil {
		return nil, fmt.Errorf("jobSet provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
