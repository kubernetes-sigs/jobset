...
type StartupPolicyApplyConfiguration struct {
	StartupPolicyOrder *v1.StartupPolicyOptions `json:"startupPolicyOrder,omitempty"`
}
...
func (b *StartupPolicyApplyConfiguration) WithStartupPolicyOrder(value v1.StartupPolicyOptions) *StartupPolicyApplyConfiguration {
