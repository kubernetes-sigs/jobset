...
type SuccessPolicyApplyConfiguration struct {
	Operator             *v1beta1.Operator `json:"operator,omitempty"`
...
func (b *SuccessPolicyApplyConfiguration) WithOperator(value v1beta1.Operator) *SuccessPolicyApplyConfiguration {
	b.Operator = &value
	return b
}
