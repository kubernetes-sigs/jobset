...
type StartupPolicyApplyConfiguration struct {
	StartupPolicyOrder *v1beta1.StartupPolicyOptions `json:"startupPolicyOrder,omitempty"`
}
...
func (b *StartupPolicyApplyConfiguration) WithStartupPolicyOrder(value v1beta1.StartupPolicyOptions) *StartupPolicyApplyConfiguration {
