...
// JobSchedulingApplyConfiguration represents a declarative configuration of the JobScheduling type for use
// with apply.
//
...
type JobSchedulingApplyConfiguration struct {
	// schedulingPolicy defines the scheduling policy (basic or gang) applied to each
	// replica of the targeted ReplicatedJobs.
	SchedulingPolicy *v1alpha3.WorkloadPodGroupSchedulingPolicy `json:"schedulingPolicy,omitempty"`
	// schedulingConstraints defines topology constraints applied to each replica of
	// the targeted ReplicatedJobs.
	SchedulingConstraints *v1alpha3.WorkloadPodGroupSchedulingConstraints `json:"schedulingConstraints,omitempty"`
	// disruptionMode defines how pods within a single replica can be disrupted.
	DisruptionMode *v1alpha3.WorkloadPodGroupDisruptionMode `json:"disruptionMode,omitempty"`
	// resourceClaims defines claims shared by all pods in each Job's PodGroup.
	ResourceClaims []v1alpha3.WorkloadPodGroupResourceClaim `json:"resourceClaims,omitempty"`
}

// JobSchedulingApplyConfiguration constructs a declarative configuration of the JobScheduling type for use with
// apply.
func JobScheduling() *JobSchedulingApplyConfiguration {
	return &JobSchedulingApplyConfiguration{}
}
...
func (b *JobSchedulingApplyConfiguration) WithSchedulingPolicy(value v1alpha3.WorkloadPodGroupSchedulingPolicy) *JobSchedulingApplyConfiguration {
...
func (b *JobSchedulingApplyConfiguration) WithSchedulingConstraints(value v1alpha3.WorkloadPodGroupSchedulingConstraints) *JobSchedulingApplyConfiguration {
...
func (b *JobSchedulingApplyConfiguration) WithDisruptionMode(value v1alpha3.WorkloadPodGroupDisruptionMode) *JobSchedulingApplyConfiguration {
...
func (b *JobSchedulingApplyConfiguration) WithResourceClaims(values ...v1alpha3.WorkloadPodGroupResourceClaim) *JobSchedulingApplyConfiguration {
	for i := range values {
