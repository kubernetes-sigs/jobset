...
func (b *JobSchedulingApplyConfiguration) WithSchedulingPolicy(value v1alpha3.PodGroupSchedulingPolicy) *JobSchedulingApplyConfiguration {
...
func (b *JobSchedulingApplyConfiguration) WithSchedulingConstraints(value v1alpha3.PodGroupSchedulingConstraints) *JobSchedulingApplyConfiguration {
...
func (b *JobSchedulingApplyConfiguration) WithDisruptionMode(value v1alpha3.DisruptionMode) *JobSchedulingApplyConfiguration {
...
func (b *JobSchedulingApplyConfiguration) WithResourceClaims(values ...v1alpha3.PodGroupResourceClaim) *JobSchedulingApplyConfiguration {
	for i := range values {
