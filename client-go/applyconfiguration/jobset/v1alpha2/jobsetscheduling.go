...
func (b *JobSetSchedulingApplyConfiguration) WithSchedulingPolicy(value v1alpha3.WorkloadCompositePodGroupSchedulingPolicy) *JobSetSchedulingApplyConfiguration {
...
func (b *JobSetSchedulingApplyConfiguration) WithSchedulingConstraints(value v1alpha3.WorkloadCompositePodGroupSchedulingConstraints) *JobSetSchedulingApplyConfiguration {
...
func (b *JobSetSchedulingApplyConfiguration) WithDisruptionMode(value v1alpha3.WorkloadCompositePodGroupDisruptionMode) *JobSetSchedulingApplyConfiguration {
