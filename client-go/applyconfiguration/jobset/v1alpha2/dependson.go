...
type DependsOnApplyConfiguration struct {
	...
	Status *v1alpha2.DependsOnStatus `json:"status,omitempty"`
}
...
func (b *DependsOnApplyConfiguration) WithName(value string) *DependsOnApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *DependsOnApplyConfiguration) WithStatus(value v1alpha2.DependsOnStatus) *DependsOnApplyConfiguration {
	b.Status = &value
	return b
}
