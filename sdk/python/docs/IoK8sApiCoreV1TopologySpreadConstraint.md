...
io_k8s_api_core_v1_topology_spread_constraint_instance = IoK8sApiCoreV1TopologySpreadConstraint.from_json(json)
# print the JSON string representation of the object
print(IoK8sApiCoreV1TopologySpreadConstraint.to_json())

# convert the object into a dict
io_k8s_api_core_v1_topology_spread_constraint_dict = io_k8s_api_core_v1_topology_spread_constraint_instance.to_dict()
# create an instance of IoK8sApiCoreV1TopologySpreadConstraint from a dict
io_k8s_api_core_v1_topology_spread_constraint_from_dict = IoK8sApiCoreV1TopologySpreadConstraint.from_dict(io_k8s_api_core_v1_topology_spread_constraint_dict)
```
