...
io_k8s_api_core_v1_empty_dir_volume_source_instance = IoK8sApiCoreV1EmptyDirVolumeSource.from_json(json)
# print the JSON string representation of the object
print(IoK8sApiCoreV1EmptyDirVolumeSource.to_json())

# convert the object into a dict
io_k8s_api_core_v1_empty_dir_volume_source_dict = io_k8s_api_core_v1_empty_dir_volume_source_instance.to_dict()
# create an instance of IoK8sApiCoreV1EmptyDirVolumeSource from a dict
io_k8s_api_core_v1_empty_dir_volume_source_from_dict = IoK8sApiCoreV1EmptyDirVolumeSource.from_dict(io_k8s_api_core_v1_empty_dir_volume_source_dict)
```
