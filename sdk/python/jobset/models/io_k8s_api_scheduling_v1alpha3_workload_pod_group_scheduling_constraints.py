...
class IoK8sApiSchedulingV1alpha3WorkloadPodGroupSchedulingConstraints(BaseModel):
    """
    WorkloadPodGroupSchedulingConstraints defines leaf-level scheduling constraints, such as topology.
    """ # noqa: E501
    topology: Optional[List[IoK8sApiSchedulingV1alpha3TopologyConstraint]] = Field(default=None, description="topology specifies desired topological placements for all pods within the pod group. If unset, no topology placement is requested.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sApiSchedulingV1alpha3WorkloadPodGroupSchedulingConstraints from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sApiSchedulingV1alpha3WorkloadPodGroupSchedulingConstraints from a dict"""
        if obj is None:
            return None
