...
class IoK8sApiCoreV1PersistentVolumeClaimCondition(BaseModel):
    ...
    """ # noqa: E501
    last_probe_time: Optional[datetime] = Field(default=None, description="Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.  Wrappers are provided for many of the factory methods that the time package offers.", alias="lastProbeTime")
