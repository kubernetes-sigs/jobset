...
class JobsetV1Network(object):
    ...
    def __init__(self, enable_dns_hostnames=None, subdomain=None, local_vars_configuration=None):  # noqa: E501
        """JobsetV1Network - a model defined in OpenAPI"""  # noqa: E501
    ...
    def enable_dns_hostnames(self):
        """Gets the enable_dns_hostnames of this JobsetV1Network.  # noqa: E501
        ...
        :return: The enable_dns_hostnames of this JobsetV1Network.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_dns_hostnames(self, enable_dns_hostnames):
        """Sets the enable_dns_hostnames of this JobsetV1Network.

        EnableDNSHostnames allows pods to be reached via their hostnames. Pods will be reachable using the fully qualified pod hostname: <jobSet.name>-<spec.replicatedJob.name>-<job-index>-<pod-index>.<subdomain>  # noqa: E501

        :param enable_dns_hostnames: The enable_dns_hostnames of this JobsetV1Network.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def subdomain(self):
        """Gets the subdomain of this JobsetV1Network.  # noqa: E501
        ...
        :return: The subdomain of this JobsetV1Network.  # noqa: E501
        :rtype: str
        """
    ...
    def subdomain(self, subdomain):
        """Sets the subdomain of this JobsetV1Network.

        Subdomain is an explicit choice for a network subdomain name When set, any replicated job in the set is added to this network. Defaults to <jobSet.name> if not set.  # noqa: E501

        :param subdomain: The subdomain of this JobsetV1Network.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JobsetV1Network):
            return False
