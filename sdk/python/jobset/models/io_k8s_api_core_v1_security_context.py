...
class IoK8sApiCoreV1SecurityContext(BaseModel):
    ...
    app_armor_profile: Optional[IoK8sApiCoreV1AppArmorProfile] = Field(default=None, alias="appArmorProfile")
    ...
    proc_mount: Optional[StrictStr] = Field(default=None, description="procMount denotes the type of proc mount to use for the containers. The default value is Default which uses the container runtime defaults for readonly paths and masked paths. Note that this field cannot be set when spec.os.name is windows.", alias="procMount")
    ...
    se_linux_options: Optional[IoK8sApiCoreV1SELinuxOptions] = Field(default=None, alias="seLinuxOptions")
    seccomp_profile: Optional[IoK8sApiCoreV1SeccompProfile] = Field(default=None, alias="seccompProfile")
    windows_options: Optional[IoK8sApiCoreV1WindowsSecurityContextOptions] = Field(default=None, alias="windowsOptions")
