...
class JobsetV1alpha1JobSetSpec(object):
    ...
    """
    openapi_types = {
        'failure_policy': 'JobsetV1alpha1FailurePolicy',
        'managed_by': 'str',
        'network': 'JobsetV1alpha1Network',
    ...
    def failure_policy(self):
        """Gets the failure_policy of this JobsetV1alpha1JobSetSpec.  # noqa: E501


        :return: The failure_policy of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :rtype: JobsetV1alpha1FailurePolicy
        """
        return self._failure_policy

    @failure_policy.setter
    def failure_policy(self, failure_policy):
        """Sets the failure_policy of this JobsetV1alpha1JobSetSpec.


        :param failure_policy: The failure_policy of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :type: JobsetV1alpha1FailurePolicy
        """
    ...
    @property
    def managed_by(self):
        """Gets the managed_by of this JobsetV1alpha1JobSetSpec.  # noqa: E501

        ManagedBy is used to indicate the controller or entity that manages a JobSet  # noqa: E501

        :return: The managed_by of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def managed_by(self, managed_by):
        """Sets the managed_by of this JobsetV1alpha1JobSetSpec.

        ManagedBy is used to indicate the controller or entity that manages a JobSet  # noqa: E501

        :param managed_by: The managed_by of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :type: str
        """
    ...
    @property
    def network(self):
        """Gets the network of this JobsetV1alpha1JobSetSpec.  # noqa: E501


        :return: The network of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :rtype: JobsetV1alpha1Network
        """
        return self._network

    @network.setter
    def network(self, network):
        """Sets the network of this JobsetV1alpha1JobSetSpec.


        :param network: The network of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :type: JobsetV1alpha1Network
        """
    ...
    def replicated_jobs(self):
        """Gets the replicated_jobs of this JobsetV1alpha1JobSetSpec.  # noqa: E501

        ReplicatedJobs is the group of jobs that will form the set.  # noqa: E501

        :return: The replicated_jobs of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :rtype: list[JobsetV1alpha1ReplicatedJob]
        """
        return self._replicated_jobs

    @replicated_jobs.setter
    def replicated_jobs(self, replicated_jobs):
        """Sets the replicated_jobs of this JobsetV1alpha1JobSetSpec.

        ReplicatedJobs is the group of jobs that will form the set.  # noqa: E501

        :param replicated_jobs: The replicated_jobs of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :type: list[JobsetV1alpha1ReplicatedJob]
        """
    ...
    def startup_policy(self):
        """Gets the startup_policy of this JobsetV1alpha1JobSetSpec.  # noqa: E501


        :return: The startup_policy of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :rtype: JobsetV1alpha1StartupPolicy
        """
        return self._startup_policy

    @startup_policy.setter
    def startup_policy(self, startup_policy):
        """Sets the startup_policy of this JobsetV1alpha1JobSetSpec.


        :param startup_policy: The startup_policy of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :type: JobsetV1alpha1StartupPolicy
        """
    ...
    def success_policy(self):
        """Gets the success_policy of this JobsetV1alpha1JobSetSpec.  # noqa: E501


        :return: The success_policy of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :rtype: JobsetV1alpha1SuccessPolicy
        """
        return self._success_policy

    @success_policy.setter
    def success_policy(self, success_policy):
        """Sets the success_policy of this JobsetV1alpha1JobSetSpec.


        :param success_policy: The success_policy of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :type: JobsetV1alpha1SuccessPolicy
        """
    ...
    @property
    def suspend(self):
        """Gets the suspend of this JobsetV1alpha1JobSetSpec.  # noqa: E501

        Suspend suspends all running child Jobs when set to true.  # noqa: E501

        :return: The suspend of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def suspend(self, suspend):
        """Sets the suspend of this JobsetV1alpha1JobSetSpec.

        Suspend suspends all running child Jobs when set to true.  # noqa: E501

        :param suspend: The suspend of this JobsetV1alpha1JobSetSpec.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JobsetV1alpha1JobSetSpec):
            return False
