...
class JobsetV1alpha2JobSetStatus(BaseModel):
    ...
    execution_attempts: Optional[StrictInt] = Field(default=None, description="executionAttempts tracks the number of execution lifecycles.", alias="executionAttempts")
