...
class IoK8sApiCoreV1PodSpec(BaseModel):
    ...
    dns_config: Optional[IoK8sApiCoreV1PodDNSConfig] = Field(default=None, alias="dnsConfig")
    ...
    os: Optional[IoK8sApiCoreV1PodOS] = None
    ...
    preemption_policy: Optional[StrictStr] = Field(default=None, description="PreemptionPolicy is the Policy for preempting pods with lower priority. One of Never, PreemptLowerPriority. When Priority Admission Controller is enabled, it prevents users from setting this field. The admission controller populates this field from PriorityClassName. Defaults to PreemptLowerPriority if unset.", alias="preemptionPolicy")
    ...
    scheduling_group: Optional[IoK8sApiCoreV1PodSchedulingGroup] = Field(default=None, alias="schedulingGroup")
    security_context: Optional[IoK8sApiCoreV1PodSecurityContext] = Field(default=None, alias="securityContext")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in eviction_responders (list)
        _items = []
        if self.eviction_responders:
            for _item_eviction_responders in self.eviction_responders:
                if _item_eviction_responders:
                    _items.append(_item_eviction_responders.to_dict())
            _dict['evictionResponders'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "evictionResponders": [IoK8sApiCoreV1EvictionResponder.from_dict(_item) for _item in obj["evictionResponders"]] if obj.get("evictionResponders") is not None else None,
