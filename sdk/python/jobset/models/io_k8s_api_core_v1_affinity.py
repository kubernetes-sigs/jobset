...
class IoK8sApiCoreV1Affinity(BaseModel):
    ...
    """ # noqa: E501
    node_affinity: Optional[IoK8sApiCoreV1NodeAffinity] = Field(default=None, alias="nodeAffinity")
    pod_affinity: Optional[IoK8sApiCoreV1PodAffinity] = Field(default=None, alias="podAffinity")
    pod_anti_affinity: Optional[IoK8sApiCoreV1PodAntiAffinity] = Field(default=None, alias="podAntiAffinity")
