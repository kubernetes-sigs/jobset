...
class JobsetV1StartupPolicy(object):
    ...
    def __init__(self, startup_policy_order='', local_vars_configuration=None):  # noqa: E501
        """JobsetV1StartupPolicy - a model defined in OpenAPI"""  # noqa: E501
    ...
    def startup_policy_order(self):
        """Gets the startup_policy_order of this JobsetV1StartupPolicy.  # noqa: E501
        ...
        :return: The startup_policy_order of this JobsetV1StartupPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def startup_policy_order(self, startup_policy_order):
        """Sets the startup_policy_order of this JobsetV1StartupPolicy.

        StartupPolicyOrder determines the startup order of the ReplicatedJobs. AnyOrder means to start replicated jobs in any order. InOrder means to start them as they are listed in the JobSet. A ReplicatedJob is started only when all the jobs of the previous one are ready.  # noqa: E501

        :param startup_policy_order: The startup_policy_order of this JobsetV1StartupPolicy.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JobsetV1StartupPolicy):
            return False
