...
class IoK8sApiCoreV1EnvVarSource(BaseModel):
    ...
    """ # noqa: E501
    config_map_key_ref: Optional[IoK8sApiCoreV1ConfigMapKeySelector] = Field(default=None, alias="configMapKeyRef")
    field_ref: Optional[IoK8sApiCoreV1ObjectFieldSelector] = Field(default=None, alias="fieldRef")
    file_key_ref: Optional[IoK8sApiCoreV1FileKeySelector] = Field(default=None, alias="fileKeyRef")
    resource_field_ref: Optional[IoK8sApiCoreV1ResourceFieldSelector] = Field(default=None, alias="resourceFieldRef")
    secret_key_ref: Optional[IoK8sApiCoreV1SecretKeySelector] = Field(default=None, alias="secretKeyRef")
