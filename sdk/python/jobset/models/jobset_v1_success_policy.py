...
class JobsetV1SuccessPolicy(object):
    ...
    def __init__(self, operator='', target_replicated_jobs=None, local_vars_configuration=None):  # noqa: E501
        """JobsetV1SuccessPolicy - a model defined in OpenAPI"""  # noqa: E501
    ...
    def operator(self, operator):
        """Sets the operator of this JobsetV1SuccessPolicy.

        Operator determines either All or Any of the selected jobs should succeed to consider the JobSet successful  # noqa: E501

        :param operator: The operator of this JobsetV1SuccessPolicy.  # noqa: E501
        :type: str
        """
    ...
    def target_replicated_jobs(self):
        """Gets the target_replicated_jobs of this JobsetV1SuccessPolicy.  # noqa: E501
        ...
        :return: The target_replicated_jobs of this JobsetV1SuccessPolicy.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def target_replicated_jobs(self, target_replicated_jobs):
        """Sets the target_replicated_jobs of this JobsetV1SuccessPolicy.

        TargetReplicatedJobs are the names of the replicated jobs the operator will apply to. A null or empty list will apply to all replicatedJobs.  # noqa: E501

        :param target_replicated_jobs: The target_replicated_jobs of this JobsetV1SuccessPolicy.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JobsetV1SuccessPolicy):
            return False
