...
class TestJobsetV1alpha2JobScheduling(unittest.TestCase):
    """JobsetV1alpha2JobScheduling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobsetV1alpha2JobScheduling:
        """Test JobsetV1alpha2JobScheduling
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobsetV1alpha2JobScheduling`
        """
        model = JobsetV1alpha2JobScheduling()
        if include_optional:
            return JobsetV1alpha2JobScheduling(
    ...
    def testJobsetV1alpha2JobScheduling(self):
        """Test JobsetV1alpha2JobScheduling"""
