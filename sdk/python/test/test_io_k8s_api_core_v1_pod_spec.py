...
class TestIoK8sApiCoreV1PodSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1PodSpec:
        """Test IoK8sApiCoreV1PodSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1PodSpec`
        """
        model = IoK8sApiCoreV1PodSpec()
        if include_optional:
