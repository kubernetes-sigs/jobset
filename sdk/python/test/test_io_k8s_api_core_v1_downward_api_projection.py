...
class TestIoK8sApiCoreV1DownwardAPIProjection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1DownwardAPIProjection:
        """Test IoK8sApiCoreV1DownwardAPIProjection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1DownwardAPIProjection`
        """
        model = IoK8sApiCoreV1DownwardAPIProjection()
        if include_optional:
