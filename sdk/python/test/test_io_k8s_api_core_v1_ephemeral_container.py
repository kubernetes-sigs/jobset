...
class TestIoK8sApiCoreV1EphemeralContainer(unittest.TestCase):
    """IoK8sApiCoreV1EphemeralContainer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1EphemeralContainer:
        """Test IoK8sApiCoreV1EphemeralContainer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1EphemeralContainer`
        """
        model = IoK8sApiCoreV1EphemeralContainer()
        if include_optional:
    ...
    def testIoK8sApiCoreV1EphemeralContainer(self):
        """Test IoK8sApiCoreV1EphemeralContainer"""
