...
class TestJobsetV1alpha2JobSchedulingPolicy(unittest.TestCase):
    """JobsetV1alpha2JobSchedulingPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobsetV1alpha2JobSchedulingPolicy:
        """Test JobsetV1alpha2JobSchedulingPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobsetV1alpha2JobSchedulingPolicy`
        """
        model = JobsetV1alpha2JobSchedulingPolicy()
        if include_optional:
            return JobsetV1alpha2JobSchedulingPolicy(
    ...
    def testJobsetV1alpha2JobSchedulingPolicy(self):
        """Test JobsetV1alpha2JobSchedulingPolicy"""
