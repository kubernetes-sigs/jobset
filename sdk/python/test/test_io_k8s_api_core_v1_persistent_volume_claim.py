...
class TestIoK8sApiCoreV1PersistentVolumeClaim(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1PersistentVolumeClaim:
        """Test IoK8sApiCoreV1PersistentVolumeClaim
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1PersistentVolumeClaim`
        """
        model = IoK8sApiCoreV1PersistentVolumeClaim()
        if include_optional:
